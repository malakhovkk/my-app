...
function getLists(statusArray, taskArray) {
  ...
  console.log(statusArray, tasksMap);
...
const List = ({ title, index, tasks, employeesMap, onTaskDrop }) => (
  <div className="list">
...
function App() {
  ...
  useEffect(() => {
    (async function () {
      const bearer =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJodHRwOi8vc2NoZW1hcy54bWxzb2FwLm9yZy93cy8yMDA1LzA1L2lkZW50aXR5L2NsYWltcy9uYW1lIjoiYWRtaW4iLCJleHAiOjE3MjU0NjA4NzEsImlzcyI6IldpbmVTZXJ2ZXIiLCJhdWQiOiJhZG1pbiJ9.yBlNFamTeVLXr7Itt504EbzhECNMyP1H9L3gBetnnoQ";
      ...
      console.log(
        getLists(
          taskStatuses,
          res.data.map((el) => ({ ...el, Task_Status: "Completed" }))
        )
      );
      console.log(res.data.map((el) => ({ ...el, Task_Status: "Completed" })));
      setLists(
        getLists(
          taskStatuses,
          res.data.map((el) => ({ ...el, Task_status: "Completed" }))
